{ pkgs, config, ... }:
{
	...
	# them) — this was a latent conflict the old location was masking.
	#
	# pip/virtualenv are pinned to 3.13 regardless of the default, matching
	# this repo's pre-existing behavior.
	home.packages = [
